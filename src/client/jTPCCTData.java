...
public class jTPCCTData
{
	...
	*/
    ...
    private void executeNewOrderStoredProcOracle(Logger log, jTPCCConnection db)
    throws Exception
    {
    ...
    private void executePaymentStoredProcOracle(Logger log, jTPCCConnection db)
    throws Exception
    {
	CallableStatement		stmt;
	Connection			conn = db.getConnection();
    ...
    private void executeOrderStatusStoredProcOracle(Logger log, jTPCCConnection db)
    throws Exception
    {
	CallableStatement	    stmt;
	Connection		    conn = db.getConnection();
    ...
    private void executeStockLevelStoredProcOracle(Logger log, jTPCCConnection db)
    throws Exception
    {
	Connection			    conn = db.getConnection();
	CallableStatement		    stmt;
    ...
    private void executeDeliveryBGStoredProcOracle(Logger log, jTPCCConnection db)
    throws Exception
    {
	CallableStatement	    stmt;
	Connection		    conn = db.getConnection();
